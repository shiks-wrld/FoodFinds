...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, MatCardModule, MatChipsModule, FlexModule, MatButtonModule, MatInputModule, FormsModule, MatIconModule, MatAutocompleteModule, MatTabsModule],
...
export class RecommendationsComponent implements OnInit {
    ...
    filteredRecommendations(): Recommendation[] {
        return this.rec.filter((r) => (r.cuisine.toLowerCase().includes(this.recommendationSearch.toLowerCase()) || r.taste.toLowerCase().includes(this.recommendationSearch.toLowerCase()) || r.mealType.toLowerCase().includes(this.recommendationSearch.toLowerCase())));
    }
}
